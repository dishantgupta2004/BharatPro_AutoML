"""AutoML MCP — Data Ingestion & Schema (in-process)."""
...
from core.workspace import list_datasets, resolve_dataset
...
def list_uploaded_files() -> dict[str, Any]:
    """List all datasets available in the local uploads directory."""
    rows = list_datasets()
    items = [
        {
            "filename": r["filename"],
