...
def register_default_servers(pool: MCPClientPool) -> None:
    ...
    """
    from mcp_servers.data import mcp as mcp_data
    from mcp_servers.eda import mcp as mcp_eda
    from mcp_servers.modeling import mcp as mcp_modeling
    from mcp_servers.explain import mcp as mcp_explain
    from mcp_servers.export import mcp as mcp_export
